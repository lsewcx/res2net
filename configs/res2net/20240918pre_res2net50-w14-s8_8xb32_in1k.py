...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        # data_root='E:/zhangjiyun/blueberry_split_clas_dataset',
        data_root='E:/zhangjiyun/blueberry',
        split='train',
...
load_from ='E:/zhangjiyun/mmpretrain-zhangjiyun/configs/_base_/pre_train/res2net50-w14-s8_3rdparty_8xb32_in1k_20210927-bc967bf1.pth'
